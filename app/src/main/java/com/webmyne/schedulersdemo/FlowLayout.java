...
/*
	@Override
	protected LinearLayout.LayoutParams generateLayoutParams(LinearLayout.LayoutParams p) {
...
*/
    ...
    public static class LayoutParams extends LinearLayout.MarginLayoutParams {
